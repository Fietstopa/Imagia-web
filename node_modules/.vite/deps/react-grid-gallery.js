  ...
  "node_modules/react-grid-gallery/dist/react-grid-gallery.umd.js"(exports, module) {
    (function(global, factory) {
      ...
      var Image = function(_a) {
        ...
        return jsxRuntimeExports.jsxs("div", __assign({ className: "ReactGridGallery_tile", "data-testid": "grid-gallery-item", onMouseEnter: function() {
          return setHover(true);
        }, onMouseLeave: function() {
          return setHover(false);
        }, style: galleryItem({ margin }) }, { children: [jsxRuntimeExports.jsx("div", __assign({ className: "ReactGridGallery_tile-icon-bar", style: tileIconBar }, { children: jsxRuntimeExports.jsx(CheckButton, { isSelected: item.isSelected, isVisible: item.isSelected || isSelectable && hover, onClick: handleCheckButtonClick }) })), !!item.tags && jsxRuntimeExports.jsx("div", __assign({ className: "ReactGridGallery_tile-bottom-bar", style: bottomBar }, { children: item.tags.map(function(tag, index2) {
          return jsxRuntimeExports.jsx("div", __assign({ title: tag.title, style: tagItemBlock }, { children: jsxRuntimeExports.jsx("span", __assign({ style: getStyle(tagStyle, tagItem, styleContext) }, { children: tag.value })) }), tag.key || index2);
        }) })), !!item.customOverlay && jsxRuntimeExports.jsx("div", __assign({ className: "ReactGridGallery_custom-overlay", style: customOverlay({ hover }) }, { children: item.customOverlay })), jsxRuntimeExports.jsx("div", { className: "ReactGridGallery_tile-overlay", style: tileOverlay({
      ...
      function useContainerWidth(defaultContainerWidth) {
        ...
        var containerRef = require$$0.useCallback(function(node) {
          var _a2;
          (_a2 = observerRef.current) === null || _a2 === void 0 ? void 0 : _a2.disconnect();
      ...
      var Gallery = function(_a) {
        var images = _a.images, _b = _a.id, id = _b === void 0 ? "ReactGridGallery" : _b, _c = _a.enableImageSelection, enableImageSelection = _c === void 0 ? true : _c, _d = _a.onSelect, onSelect = _d === void 0 ? function() {
        } : _d, _e = _a.rowHeight, rowHeight = _e === void 0 ? 180 : _e, maxRows = _a.maxRows, _f = _a.margin, margin = _f === void 0 ? 2 : _f, _g = _a.defaultContainerWidth, defaultContainerWidth = _g === void 0 ? 0 : _g, _h = _a.onClick, onClick = _h === void 0 ? function() {
        } : _h, tileViewportStyle = _a.tileViewportStyle, thumbnailStyle = _a.thumbnailStyle, tagStyle = _a.tagStyle, thumbnailImageComponent = _a.thumbnailImageComponent;
        ...
        return jsxRuntimeExports.jsx("div", __assign({ id, className: "ReactGridGallery", ref: containerRef }, { children: jsxRuntimeExports.jsx("div", __assign({ style: gallery }, { children: thumbnails.map(function(item, index) {
          return jsxRuntimeExports.jsx(Image, { item, index, margin, height: rowHeight, isSelectable: enableImageSelection, onClick: handleClick, onSelect: handleSelect, tagStyle, tileViewportStyle, thumbnailStyle, thumbnailImageComponent }, item.key || index);
        }) })) }));
      };
