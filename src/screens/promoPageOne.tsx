      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 px-5 h-full">
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            Vítejte v ateliéru Imagia – útulném a kreativním prostoru pro focení
            v srdci Brna. Najdete nás na ulici Milady Horákové, jen pár minut
            jízdy z centra města. <br /> <br /> Náš ateliér propojuje moderní
            fotografii s osobním a přívětivým přístupem – ideální pro portréty,
            rodinná focení nebo profesionální snímky. Přijet k nám je snadné:
            stačí naskočit na{" "}
            <a className="relative group text-[#C6AB81] font-bold underline cursor-pointer">
              ...
              <span className="absolute hidden group-hover:block top-7 left-1/2 -translate-x-1/2 w-[450px] text-white text-sm font-sans px-3 py-2 bg-[#1F1A16] shadow-lg z-50">
                ...
                <img src={mapimage} alt="Mapa k ateliéru Imagia" />
              </span>
            </a>
