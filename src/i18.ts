...
const resources = {
  ...
  ru: {
    translation: {
      ...
      descriptionText:
        "Современная фотостудия с профессиональным оборудованием для съёмки в любом стиле. Уютное пространство идеально подойдёт для портретов, контента и коммерческих проектов. Гарантируем комфорт, креатив и высокое качество каждого кадра.<br/><br/>Наша студия сочетает современную фотографию с индивидуальным и дружелюбным подходом – идеально подходит для портретов, семейных фотографий или профессиональных снимков. Добраться сюда легко: просто садитесь на <tram>Трамвай номер 9</tram> и вы буквально в нескольких шагах от наших дверей.<br/><br/>Imagia — это пространство для вашего творчества, где вы можете запечатлеть важные моменты своей жизни или создать что-то уникальное. Мы с радостью поможем с воплощением любых ваших идей!",
      altTags: {
